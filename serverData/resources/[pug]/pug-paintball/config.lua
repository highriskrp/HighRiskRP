...
Config.UsingCrossHairByDefault = true -- This was requested for server that have crosshair on always. If you are one of those servers then make this true or else just leave it.
