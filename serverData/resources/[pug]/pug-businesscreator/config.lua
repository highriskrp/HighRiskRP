...
------------------------------
---------- [STRINGS] ----------
Config.inventoryImagesDirectoryPath = "resources/[qb]/qb_inventory/html/images/" -- Image directory path to your inventory script so that images can be saved to it when you make new items.
...
------------------------------
---------- [BOOLS] ----------
---We're definitely on new QBCore.  - Cyber
