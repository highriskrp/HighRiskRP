...
## If using OX then place in `qs-inventory/data/weapons.lua`
...
```lua
    ...
    [`WEAPON_SK47PINK2`] 		 = {['name'] = 'WEAPON_SK47PINK2', 	 	['label'] = 'SK47PINK2', 				['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},    
...
```lua
	...
	[GetHashKey("WEAPON_SK47PINK2")] = 0.5,
