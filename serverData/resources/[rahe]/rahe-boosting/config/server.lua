svConfig = {
    ...
    storeItems = {
        ...
        ['spart'] = {
            ...
            availablePerRestart = 5,
            isSoldOut = false,
            title = "Spare parts crate (Bulletproof)",
...
supportedVehicles = {
    ...
    { name = "subwrx", model = "subwrx", class = "B" },
    { name = "stingray", model = "stingray", class = "S" },
}