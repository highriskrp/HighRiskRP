svConfig = {
    ...
    competitionNotificationWebHook = 'https://discord.com/api/webhooks/1396257751390224384/sTIpiItvSWytZLTbJjFJznJxLOu0RE0jq5eCol4QEODHFYvIkV9_jgFqeRInhVL3fNov',
