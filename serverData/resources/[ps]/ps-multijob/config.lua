...
Config.DenyDuty = {
	-- Setting these true is what caused that "You are not allowed to use this station for clock-in" message when using the J menu.
	["ambulance"] = false,
	["police"] = false,
}

Config.WhitelistJobs = {
	-- These jobs will deny duty to anyone who doesn't already have them
	["police"] = true,
	["ambulance"] = true,
	["mechanic"] = true,
	["judge"] = true,
