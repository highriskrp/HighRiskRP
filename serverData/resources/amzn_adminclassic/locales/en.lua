Translations = {
    html = {
        ...
        ChoseOneTranslation = "Choose one",
        ...
        itemWhoToGiveTranslation = "Who do you want to give the item to?<br/><p class=\"small text-muted\">LEAVE BLANK IF YOURSELF</p>",
    ...
    alerts = {
        ...
        cantFindPlayer = "Can't find player.",
        ...
        changedTime = "Changed time to %{value}:00",
