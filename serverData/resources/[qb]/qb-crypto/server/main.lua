...
RegisterServerEvent('qb-crypto:server:ExchangeFail', function()
    ...
    if ItemData ~= nil then
        Player.Functions.RemoveItem('cryptostick', 1, false, 'qb-crypto:server:ExchangeFail')
...
RegisterServerEvent('qb-crypto:server:ExchangeSuccess', function(LuckChance)
    ...
    if ItemData ~= nil then
        ...
        Player.Functions.RemoveItem('cryptostick', 1, false, 'qb-crypto:server:ExchangeSuccess')
