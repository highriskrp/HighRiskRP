...
Config.General = {
    ...
    SearchCooldown = 10000, -- In miliseconds
...
Config.Reward = {
    ...
    -- Items you can get
    ItemList = {
        "water_bottle", "metalscrap", "garbage", "hotgarbage", "plastic",
        "copper", "garbage", "hotgarbage", "glass", "lockpick",
        "garbage", "hotgarbage", "binoculars", "lighter", "garbage",
        "hotgarbage", "beer", "tosti", "garbage", "hotgarbage", "cryptostick",
        "handcuffs", "garbage", "hotgarbage", "bleachwipes", "bands", "garbage",
        "hotgarbage", "lockpick", "pistol_ammo", "garbage", "hotgarbage",
        "smg_ammo", "cokebaggy", "garbage", "hotgarbage", "lockpick", "bobby_pin",
        "garbage", "hotgarbage", "lockpick", "bandages", "garbage", "hotgarbage",
        "handcuffs", "stopsign", "garbage", "hotgarbage", "uturnsign", "bobby_pin", 
        "garbage", "hotgarbage", "bobby_pin", "thermite", "garbage", "hotgarbage",
        "trojan_usb", "garbage", "hotgarbage",
    }
}
