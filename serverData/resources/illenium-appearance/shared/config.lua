...
Config.Stores = {
    ...
    {
        type = "clothing", --legion
        coords = vector4(196.75, -876.08, 30.71, 245),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
        showBlip = true, -- overrides the blip visibilty configured above for the group
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vector3(203.23, -871.20, 30.71),
            vector3(195.28, -869.19, 30.71),
            vector3(191.48, -880.83, 30.95),
            vector3(198.82, -883.60, 30.71)
        }
    },
    {
        type = "clothing", --696
        coords = vector4(-710.98, -154.55, 37.42, 111.9),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing", --539
        coords = vector4(-160.99, -303.08, 39.73, 244.26),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing", --644
        coords = vector4(-1452.16, -236.64, 49.81, 40.62),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing", --583
        coords = vector4(123.05, -220.70, 54.56, 331),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(133.05, -209.98, 54.56),
            vector3(123.74, -206.59, 54.56),
            vector3(116.43, -228.05, 54.56),
            vector3(123.67, -230.05, 54.56)
        }
    },
    {
        type = "clothing", --PD
        coords = vector4(-1860.06, -329.6, 44.01, 289.35),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(-1855.57, -330.84, 44.01),
            vector3(-1858.32, -333.71, 44.01),
            vector3(-1862.77, -329.47, 44.01),
            vector3(-1859.76, -327.2, 44.51)
        }
    },
    {
        type = "clothing", --MRPD
        coords = vector4(457.54, -989.04, 30.69, 168),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(449.29, -993.69, 31.13),
            vector3(450.93, -988.36, 30.69),
            vector3(460.52, -988.27, 30.69),
            vector3(460.36, -993.19, 30.69)
        }
    },
    {
        type = "clothing", --NHS
        coords = vector4(296.96, -595.42, 43.28, 268),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = false,
        points = {
            vector3(295.13, -598.32, 43.32),
            vector3(297.17, -593.97, 43.28),
            vector3(300.87, -595.27, 43.28),
            vector3(298.97, -599.72, 43.32)
        }
    },
    {
        type = "barber",
    ...
    {
        type = "surgeon",
        coords = vector4(323.69, -585.03, 43.28, 69),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(325.01, -582.14, 44.20),
            vector3(322.72, -587.97, 44.20),
            vector3(316.44, -585.90, 43.28),
            vector3(318.82, -579.73, 43.28)
        }
    }
}
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(-1858.5, -333.11, 44.01, 22.81),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1858.32, -333.71, 44.01),
            vector3(-1855.39, -330.81, 44.01),
            vector3(-1863.46, -323.79, 44.01),
            vector3(-1865.83, -326.4, 44.01)
        }
    },
    {
        job = "ambulance",
        coords = vector4(-437.48, -309.31, 34.91, 197.47),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-435.37, -310.9, 34.91),
            vector3(-437.01, -307.16, 34.91),
            vector3(-439.28, -308.08, 34.91),
