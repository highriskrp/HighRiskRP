...
if Config.MLOSelection == 'prompt-prison' then
    PathfindingConfig.PathfindingSettings = {
        ...
        tutorialCamerasMax = {
            ...
            { coords = vector4(1755.71, 2498.64, 45.65, 22),   rotation = vector2(0.0, 0.0),   wait = 3000, tutorialText = "" },
            { coords = vector4(1745.05, 2518.77, 45.57, 28),   rotation = vector2(0.0, 0.0),   wait = 3000, tutorialText = "" },
            { coords = vector4(1703.52, 2491.06, 45.56, 5),   rotation = vector2(0.0, 0.0),   wait = 3000, tutorialText = "HERE IS THE YARD ITS NOT MUCH BUT ITS ALL YOU GOT" },
            { coords = vector4(1730.94, 2481.62, 45.56, 175.18),   rotation = vector2(0.0, 0.0),   wait = 3000, tutorialText = "" },
            { coords = vector4(1761.80, 2454.43, 45.57, 311),   rotation = vector2(0.0, 0.0),   wait = 3000, tutorialText = "" },
