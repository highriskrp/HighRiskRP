...
Config.FlashlightRange = 25 -- Default: 15 / Distance one can see evidence with flashlight (MUST BE ABOVE 2)
...
-- Copy starting here to add new location
    LSPD = {
        ...
        label = 'WYPD', -- Label to display during certain situations/notifications

        analyze = {
            coords = vec3(-1856.61, -327.07, 20.68), -- Coords for location(If target is not enabled)
            ...
            target = {
                ...
                coords = vec3(-1856.61, -327.07, 20.68),
                heading = 139.57,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
        ...
        fingerprinting = {
            ...
            coords = vec3(-1849.78, -323.75, 44.01), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Take Suspect\'s Fingerprints', -- TextUI string(If target is not enabled)
            target = {
                enabled = true, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Take Suspect\'s Fingerprints',
                coords = vec3(-1849.78, -323.75, 44.01),
                heading = 228.43,
                width = 2.0,
                length = 1.0,
                minZ = 26.26-0.9,
        ...
        storage = {
            ...
            coords = vec3(-1859.13, -328.18, 20.68), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Access Evidence Storage', -- TextUI string(If target is not enabled)
            target = {
                enabled = true, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Access Evidence Storage',
                coords = vec3(-1859.13, -328.18, 20.68),
                heading = 43.13,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
...
-- Stop copying here and paste below, and rename LSPD to something else and re-configure for additional locations
 LSPD = {
        ...
        label = 'MRPD', -- Label to display during certain situations/notifications

        analyze = {
            coords = vec3(459.56, -978.25, 24.91), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Analyze Evidence', -- TextUI string(If target is not enabled)
            target = {
                enabled = true, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Analyze Evidence',
                coords = vec3(459.56, -978.25, 24.91),
                heading = 139.57,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
        ...
        fingerprinting = {
            enabled = true, -- Enable a finger printing station. By default this will be used to reveal any 'unknown' fingerprints that are ran through the system.
            coords = vec3(463.64, -992.71, 24.91), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Take Suspect\'s Fingerprints', -- TextUI string(If target is not enabled)
            target = {
                enabled = true, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Take Suspect\'s Fingerprints',
                coords = vec3(463.64, -992.71, 24.91),
                heading = 228.43,
                width = 2.0,
                length = 1.0,
                minZ = 26.26-0.9,
        ...
        storage = {
            enabled = true, -- Enable archive access in-game via storage location?
            coords = vec3(473.27, -983.10, 24.91), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Access Evidence Storage', -- TextUI string(If target is not enabled)
            target = {
                enabled = true, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Access Evidence Storage',
                coords = vec3(473.27, -983.10, 24.91),
                heading = 43.13,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
