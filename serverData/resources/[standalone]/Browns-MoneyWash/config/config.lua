...
config.percentage = 90 -- the percentage of washed money you receive out of the dirty money you wash

config.dirtymoney = {

    UsingMarkedMoney = false, -- if using Marked Money (QBCore) then set this to true and ignore "DirtyMoneyItem" & "DirtyMoneyName"

    MarkedMoneyName = 'bands', -- the name of your Marked Money (QBCore) only change if "UsingMarkedMoney" is true
