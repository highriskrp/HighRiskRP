...
Config.Setup = {
    ...
    -- Ox: use charId
    admins = {
        ['fivem:6611109'] = true, --Dani
        ['fivem:13126835'] = true, --Rossy
        ['fivem:15345438'] = true, --Warier
...
Config.Strains = {
    ...
    ['amber_kush'] = {
        label = 'Amber Kush',
        seed = 'amber_kush_seed',
        bud = 'amber_kush_top',
        bag = 'amber_kush_gram',
        joint = 'amber_kush_joint',
        level = 2,
        exp = { min = 12, max = 16 },
        yields = {
            buds = { min = 4, max = 12 },
    ...
    ['orange_haze'] = {
        label = 'Orange Crush',
        seed = 'orange_haze_seed',
        bud = 'orange_haze_top',
        bag = 'orange_haze_gram',
        joint = 'orange_haze_joint',
        level = 5,
        exp = { min = 8, max = 12 },
        yields = {
            buds = { min = 4, max = 12 },
    ...
    ['aurora_haze'] = {
        label = 'Aurora Haze',
        seed = 'aurora_haze_seed',
        bud = 'aurora_haze_top',
        bag = 'aurora_haze_gram',
        joint = 'aurora_haze_joint',
        level = 6,
        exp = { min = 10, max = 14 },
        yields = {
            buds = { min = 4, max = 12 },
    ...
    ['white_haze'] = {
        label = 'Greymatter Grass',
        seed = 'white_haze_seed',
        bud = 'white_haze_top',
        bag = 'white_haze_gram',
        joint = 'white_haze_joint',
        level = 6,
        exp = { min = 12, max = 16},
        yields = {
            buds = { min = 4, max = 12 },
    ...
    ['blood_kush'] = {
        label = 'Rossys Kush D',
        seed = 'blood_kush_seed',
        bud = 'blood_kush_top',
        bag = 'blood_kush_gram',
        joint = 'blood_kush_joint',
        level = 6,
        exp = { min = 12, max = 16 },
        yields = {
            buds = { min = 4, max = 12 },
...
Config.Shop = {
    ...
    location = vec4(-1550.49, -429.30, 35.89, 183),
    ...
    items = {
        ...
        [1] = { item = 'watering_can', price = 20, label = 'Water', icon = 'droplet', min = 1, max = 1 },
        [2] = { item = 'fertilizer', price = 20, label = 'Fertilizer', icon = 'burger', min = 1, max = 1 },
        [4] = { item = 'mini_shovel', price = 200, label = 'Shovel', icon = 'trowel', min = 1, max = 1 },
        [5] = { item = 'shears', price = 200, label = 'Shears', icon = 'scissors', min = 1, max = 1 },
        [6] = { item = 'ocb_paper', price = 1, label = 'Rolling Paper', icon = 'joint', min = 1, max = 50 },
        [7] = { item = 'emptybaggies', price = 1, label = 'Empty Baggy', icon = 'bag-shopping', min = 1, max = 50 },
        [8] = { item = 'weed_table', price = 100000, label = 'Weed Table', icon = 'cannabis', min = 1, max = 1 },
...
Config.Growth = {
    ...
    watering = { item = 'watering_can', min = 40.0, max = 60.0 },
    ...
    fertilizing = { item = 'fertilizer', min = 40.0, max = 60.0 },
            ...
            [1] = {
                ...
                buds = {
                    ...
                    ['cannabis'] = {
                        ...
                        remove_item = { item = 'ocb_paper', quantity = 1 },
            ...
            [1] = {
                ...
                buds = {
                    ...
                    ['cannabis'] = {
                        ...
                        remove_item = { item = 'emptybaggies', quantity = 1 },
...
Config.Table = {
    ...
    buds = {
        ...
        ['cannabis'] = {
            ...
            remove_item = {
                rolling = { item = 'ocb_paper', quantity = 1 },
                bagging = { item = 'emptybaggies', quantity = 1 }
            },
            ...
            -- This allows you to make this action AFK or not
            max_actions = { rolling = 25, bagging = 25 },
...
Config.Joints = {
    ...
    ['cannabis_joint'] = {
        ...
        effects = {
            ...
            armor = { enable = true, amount = 1, max = 5 },
            -- enable: do you want to enable this effect?
            ...
            -- duration: if enabled, how long (in milliseconds) to activate the effect
            walk = { enable = false, clipset = 'move_m@drunk@a', duration = 30000 },
            -- enable: do you want to enable this effect?
    ...
    ['orange_haze_joint'] = {
        ...
        effects = {
            health = { enable = true, amount = 25 },
            armor = { enable = true, amount = 5, max = 10 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 15000 },
            walk = { enable = false, clipset = 'move_m@drunk@a', duration = 30000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 15000 }
    ...
    ['amber_kush_joint'] = {
        ...
        effects = {
            health = { enable = true, amount = 25 },
            armor = { enable = true, amount = 10, max = 15 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 15000 },
            walk = { enable = false, clipset = 'move_m@drunk@a', duration = 30000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 15000 }
    ...
    ['white_haze_joint'] = {
        ...
        effects = {
            health = { enable = true, amount = 25 },
            armor = { enable = true, amount = 15, max = 20 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 15000 },
            walk = { enable = false, clipset = 'move_m@drunk@a', duration = 30000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 15000 }
