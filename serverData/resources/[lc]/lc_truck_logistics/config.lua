...
Config.trucker_locations = {
	["trucker_1"] = {															-- ID
		['menu_location'] = {1206.36, -3158.75, 5.53},	-- Coordinate to open the menu (vector3)
...
Config.jobs = {
	...
	['economy'] = {
		['price_per_km'] = {					-- Base price range
			['min'] = 500,						-- Minimum price per kilometer
			['max'] = 700,						-- Maximum price per kilometer
		},
		['multipliers'] = {
...
Config.drivers = {
	...
	['hiring_costs'] = {						-- Cost of hiring the driver (this amount will only be paid at the time of hiring)
		['min'] = 100,							-- This is the minimum base cost of hiring the employee
		['max'] = 10000,							-- This is the maximum base cost of hiring the employee (this amount will increase according to the employee's skills)
	...
	['max_drivers_per_player'] = {				-- Maximum number of drivers the player can hire per level
		[0] = 3,								-- Between level 0 to 10 player will be able to hire 1 driver
		[10] = 5,								-- Between level 10 to 20 player will be able to hire 2 drivers
		[20] = 7,								-- etc
		[30] = 10
	}
}
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		...
		['max'] = 500,							-- Maximum base profit, this will be the maximum amount of money this driver can generate (this amount will increase according to the driver's skills)
...
Config.party = {
	...
	['party_exp_bonus'] = 10,		-- Bonus xp (in %) that each party member receives when completing a delivery
